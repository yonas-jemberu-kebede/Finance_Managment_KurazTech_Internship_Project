...
Route::middleware(['role:admin'])->group(function(){
    ...
    Route::get('incometransaction/index',[IncomeTransactionController::class,'index'])->name('incometransaction.index');
    Route::get('incometransaction/{customer}/edit',[IncomeTransactionController::class,'edit'])->name('incometransaction.edit');
    Route::post('incometransaction/store/',[IncomeTransactionController::class,'store'])->name('incometransaction.store');
    Route::delete('incometransaction/delete/{customer}',[IncomeTransactionController::class,'delete'])->name('incometransaction.delete');
    Route::patch('incometransaction/update/{customer}',[IncomeTransactionController::class,'update'])->name('incometransaction.update');
